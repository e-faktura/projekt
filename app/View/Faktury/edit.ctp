...
<?php echo $this->Form->create('Faktura'); ?>
	...
	<?php
		...
		echo $this->Form->input('data_wystawienia', array( 'label' => 'Data wystawienia', 'type' => 'date', 'dateFormat' => 'DMY', 'separator' => '' ));
		echo $this->Form->input('data_sprzedazy', array( 'label' => 'Data sprzedaży', 'type' => 'date', 'dateFormat' => 'DMY', 'separator' => '' ));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Faktura.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Faktura.id'))); ?></li>
