...
<head>
	...
	<?php
		...
		echo $this->Html->css('themes/bootstrap/jquery-ui-1.10.0.custom');
	...
	<div class="container">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<?php
					if( $this->params['action'] == 'edycja' || $this->params['action'] == 'nowy' || $this->params['action'] == 'nowa' || $this->params['action'] == 'login' ){
